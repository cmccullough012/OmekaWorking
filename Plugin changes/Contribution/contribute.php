        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <fieldset id="contribution-confirm-submit" <?php if (!isset($type)) { echo 'style="display: none;"'; }?>>
                ...
                <div class="inputs">
                    ...
                    <?php echo $this->formCheckbox('contribution-public', $public, null, array('0', '1')); ?>
                    <?php echo $this->formLabel('contribution-public', __('Allow my contribution to be included in exhibits, collections, or items at administrator\'s discretion (If unchecked, your contribution can never be made visible to anyone but administrators.)')); ?>
                </div>
                <div class="inputs">
